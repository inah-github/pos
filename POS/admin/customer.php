...
<div class="sidenav" id="mySidenav">
	...
	<!-- Dropdown_Entries -->
	<button class="dropdown-btn active"><i style="left: right; padding-right: 5px;" class="fas fa-box-open"></i>&nbsp;Customer<i style="float: right; padding-right: 5px; margin-top: 2px;" class="fa fa-plus"></i></button>
	<div class="dropdown-container">
		<a href="javascript:" data-toggle="modal" data-target="#myCustomerType">Customer Type</a>
		<a class="active" href="javascript:">Customer Information</a>
	</div>
	<button class="dropdown-btn"><i style="left: right; padding-right: 5px;" class="fas fa-box-open"></i>&nbsp;Product<i style="float: right; padding-right: 5px; margin-top: 2px;" class="fa fa-plus"></i></button>
	<div class="dropdown-container">
		<a href="javascript:">Product Brand</a>
		<a href="javascript:">Product Category</a>
		<a href="javascript:">Product Information</a>
	</div>
	<button class="dropdown-btn"><i style="left: right; padding-right: 5px;" class="fas fa-box-open"></i>&nbsp;Sales<i style="float: right; padding-right: 5px; margin-top: 2px;" class="fa fa-plus"></i></button>
	<div class="dropdown-container">
		<a href="javascript:">Product Brand</a>
		<a href="javascript:">Product Category</a>
		<a href="javascript:">Product Information</a>
	</div>
	<button class="dropdown-btn"><i style="left: right; padding-right: 5px;" class="fas fa-barcode"></i>&nbsp;Barcode<i style="float: right; padding-right: 5px; margin-top: 2px;" class="fa fa-plus"></i></button>
	<div class="dropdown-container">
		<a href="javascript:">Product Brand</a>
		<a href="javascript:">Product Category</a>
		<a href="javascript:">Product Information</a>
	</div>
	<button class="dropdown-btn"><i style="left: right; padding-right: 5px;" class="fas fa-box-open"></i>&nbsp;Reports<i style="float: right; padding-right: 5px; margin-top: 2px;" class="fa fa-plus"></i></button>
	<div class="dropdown-container">
		<a href="javascript:">Product Brand</a>
		<a href="javascript:">Product Category</a>
		<a href="javascript:">Product Information</a>
...
<!-- Customer_Modal -->
	<div class="customer-information">
		<div id="myCustomer" class="modal fade" role="dialog">
					...
					<div class="modal-body">
						<form method="POST">
							...
							<div class="form-group input-group">
								...
								<input type="text" name="" class="form-control" placeholder="Customer Code">
							</div>
							<div class="form-group">
							...
							<div class="form-group input-group">
								...
								<input type="text" name="" class="form-control" placeholder="Customer Contact">
							</div>
							<div class="form-group">
							...
							<div class="form-group input-group">
								...
								<textarea class="form-control" type="text" placeholder="Customer Address"></textarea>
							</div>
							<div class="form-group">
...
<!-- Customer_Type -->
	<div class="customer-information">
		<div id="myCustomerType" class="modal fade" role="dialog">
			<div class="modal-dialog">
				<!-- Modal Content -->
				<div class="modal-content">
					<!-- Mdal Header -->
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal">&times;</button>
						<h3 style="text-align: center;">New Customer Type</h3>
					</div>
					<div class="modal-body">
						<form method="POST">
							<div class="form-group">
								<label for="">Customer Type Code</label>								
							</div>
							<div class="form-group input-group">
								<span class="input-group-addon"><i class="glyphicon glyphicon-barcode"></i></span>
								<input type="text" name="" class="form-control" placeholder="Customer Type Code">
							</div>
							<div class="form-group">
								<label for="">Customer Type</label>
							</div>	
							<div class="form-group input-group">
								<span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>						
								<input type="text" name="" class="form-control" placeholder="Customer Type">
							</div>							
							<!-- Modal Footer -->
							<div class="modal-footer">
								<input type="reset" class="btn btn-md btn-warning" name="" value="Cancel">
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-md-8">
				...
				<span style="float: left; padding: 0px 0px; font-size:32px;cursor:pointer">&copy;POS</span>
				<!-- <span style="float: left;"><img style="width: 128px; height: 128px;" src="../iss.png"></span> -->
			</div>
	...
	<div class="customer-search">
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-md-2">
					<a style="float: right;" href="javascript:" type="button" class="btn btn-md btn-warning add-customer" data-toggle="modal" data-target="javascript:"><i class="fa fa-plus-circle fa-lg"></i>&nbsp;Print Masterlist</a>
				</div>
				<div class="col-md-2">
